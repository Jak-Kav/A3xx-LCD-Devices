This folder is a complete working demo of the LCD. Simply download the folder and open the `RUD_BAT_RAD_TCAS_TEST.ino` file in arduino and flash to your device.    
