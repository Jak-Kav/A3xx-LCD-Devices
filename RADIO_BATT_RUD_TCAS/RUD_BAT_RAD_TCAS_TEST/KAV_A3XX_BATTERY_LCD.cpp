 ...
 */
void KAV_A3XX_BATTERY_LCD::handleMobiFlightRaw(char *cmds)
{
 ...
 */
void KAV_A3XX_BATTERY_LCD::handleMobiFlightCmd(char *cmd)
{
    ...
    else if (strcmp(cmd, "showBattVal") == 0)
